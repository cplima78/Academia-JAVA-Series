package br.com.academia.finaljava.principal;

import br.com.academia.finaljava.model.*;
...
public class Principal {
    ...
    private final String API_KEY = "&apikey=4e80e981";
    ...
    private void topEpisodiosPorSerie() {
        ...
        if (serieBusca.isPresent()) {
            ...
            topEpisodios.forEach(e ->
                    System.out.printf("Série: %s Temporada %s - Episodio %s - %s Avaliacao %s\n",
                            e.getSerie().getTitulo(), e.getTemporada(),
